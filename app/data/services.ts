...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: 'From consumer apps to internal field tools, we design and ship mobile applications that feel native, perform reliably offline, and integrate cleanly with your backend. We help you choose the right approach — cross-platform for speed and shared codebase, or fully native when performance, platform APIs, or App Store constraints demand it — and we support the full lifecycle including store submission, push notifications, and analytics instrumentation.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'A lot of application problems are actually data problems — slow queries, inconsistent schemas, or an architecture that made sense at 10,000 rows and breaks at 10 million. We design database architecture up front and fix it under load: schema design, indexing and query optimization, replication and backup strategy, and migrations between relational and NoSQL systems.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'Some workflows are specific enough that no off-the-shelf product will ever fit cleanly. We build custom enterprise software — internal tools, workflow and approval systems, and integration layers that connect the platforms you already run — so operational teams get software shaped around how the business actually works, not the other way around.',
    capabilities: [
